...
const Navbar = () => {
   ...
   // const userRole = profile ? profile.userRole : undefined;
    const userRole = profile?.userRole; //conditional chaining
  ...
  return (
       ...
       <div className='bg-purple-100 text-purple-950 grid grid-cols-1 md:grid-cols-2 p-3 shadow-md'>
        ...
        <div className='flex justify-center md:justify-end items-center mt-2 md:mt-0 space-x-5 md:space-x-10'>
           ...
           {userRole==="admin" && (<Link to="/add-course" className='ml-20'>Add Course</Link>)    }
           <Logout />
        </div>
    </div>
  )
